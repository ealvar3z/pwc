...
// IsPrime returns whether or not an int is prime.
...
// PrimeSieve is for primes up to and including 'limit'.
...
// Primes returns a slice of all primes up to and including 'limit'.
...
// PrimeCount sieves for primes up to and including 'n' and returns how many there are.
...
// PrimeFactors returns the prime factors of 'n' in order using a wheel with basis [2, 3, 5].
...
// Divisors returns all the divisors of 'n' including 1 and 'n' itself.
...
// ProperDivisors returns all the divisors of 'n' excluding 'n'.
...
// Digits returns a slice of an int's digits in base b.
...
// DigitSum returns the sum of an int's digits in base b.
...
// MaxInts returns the maximum of a slice of ints (64-bit assumed)
...
// MinInts returns the minimum of a slice of ints (64-bit assumed)
...
// Commatize adds thousand separators to an int.
...
// PrintTable prints a slice of ints in tabular form with a given row and column size
